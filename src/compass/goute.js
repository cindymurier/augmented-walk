    ...
    */
    ...
    display(ctx) {
        ...
        for (let i = 0; i < this.nodes; i++) {
            ...
            if ((this.points[i].step > 0 && this.points[i].rad > this.points[i].rad2) || (this.points[i].step < 0 && this.points[i].rad < this.points[i].rad2)) {
                this.points[i].rad2 = this.rnd(this.size * 0.5, this.size * 1.5)
                this.points[i].step = (this.points[i].rad2 - this.points[i].rad) / this.rnd(this.speed / 2, this.speed);
            }
        ...
        if (DEBUG) {
            ...
            for (let i = 0; i < this.nodes; i++) {
                ...
                ctx.bezierCurveTo(this.points[i].cx1, this.points[i].cy1, this.points[next].cx2, this.points[next].cy2, this.points[next].x, this.points[next].y);
                ctx.stroke();
                ctx.closePath();
